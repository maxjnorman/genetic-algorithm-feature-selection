...
root = Clade(
    initial_descendants=[
        Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),
        Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),
        Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),
        Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),
        Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),
        ...
        Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),
        Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction),Individual(model=tree(max_depth=3), train_fraction=train_fraction)],
    n_max=128, max_daughters=max_daughters, train_fraction=train_fraction
    )
# vine = Clade(
